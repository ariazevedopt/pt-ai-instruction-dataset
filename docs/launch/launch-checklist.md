...
- [ ] **Set up Gumroad products** (issue #26)
  ...
  2. Individual (€29): upload `lusosupport_pt_v1.jsonl` + CSV + Alpaca JSONL + AMALIA chat JSONL + Parquet + `LICENCE-COMMERCIAL.md`
  3. Commercial (€115): same files + `LICENCE-COMMERCIAL.md` commercial tier
