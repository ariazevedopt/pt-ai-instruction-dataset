...
- **Individual / Research (€29):** personal, research, and non-commercial internal use. Not for resale or redistribution as a data product.
- **Commercial (€115):** all Individual uses, plus commercial software, SaaS APIs, consulting deliverables, and team/organisation use.
